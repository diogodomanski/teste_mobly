...
class Product extends \Application\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'description', 'price', 'categories', 'features', 'images');
        }
...
), \Doctrine\ORM\EntityManager $em = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hydrate', array($options, $em));

        return parent::hydrate($options, $em);
    }
    ...
    public function toVO()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'toVO', array());
